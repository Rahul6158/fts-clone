...
st.markdown(f'<p style="color:#FF5733">{quote}</p>', unsafe_allow_html=True)  # Change color for the quote
st.markdown(f'<p style="color:#33FFA8">- {author}</p>', unsafe_allow_html=True)  # Change color for the author
